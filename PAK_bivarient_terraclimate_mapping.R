...
crs_proj <- "+proj=aea +lat_1=25 +lat_2=35 +lon_0=70 +datum=WGS84 +units=m"   # JGD2011 / Japan Albers Equal Area, Sri Lanka: 32644, Thailand: 32647
# Pakistan: "+proj=aea +lat_1=25 +lat_2=35 +lon_0=70 +datum=WGS84 +units=m"
...
new_res <- 500   # metres (adjust for desired resolution)
...
dem <- elevatr::get_elev_raster(
  locations = roi_simp0, z = 10,        # resolution ~30 m
  clip = "locations"
) |> terra::rast() |>
...
map <- ggplot() +
  ...
  labs(
    title = "Pakistan: Temperature and Precipitation Patterns", 
...
ggsave(paste0(out.dir, "/", "PAK_Temp_PPT_Hillshade.png"), finalPlot, 
       width = 12, height = 11, dpi = 300, bg = "white")

message("Hillshade map saved to ./output_png/PAK_Temp_PPT_Hillshade.png")
