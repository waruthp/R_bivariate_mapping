...
crs_proj <- "EPSG:32647"   # JGD2011 / Japan Albers Equal Area, Sri Lanka: 32644, Thailand: 32647
...
map <- ggplot() +
  ...
  labs(
    title = "Thailand: Temperature and Precipitation Patterns", 
...
ggsave(paste0(out.dir, "/", "THA_Temp_PPT_Hillshade.png"), finalPlot, 
       width = 12, height = 11, dpi = 300, bg = "white")

message("Hillshade map saved to ./output_png/THA_Temp_PPT_Hillshade.png")
